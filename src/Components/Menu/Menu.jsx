...
import NavItemMenu from "./components/NavItemMenu/NavItemMenu";
// import PropTypes from "prop-types";
import "./Menu.scss";
function Menu(props) {
  const { navLink, changeVis } = props;
  useEffect(() => {
    const openMenu = document.querySelector("#openSubMenu");
    const closeMenu = document.querySelector("#closeSubMenu");
    const subMenu = document.getElementById("subMenu");
    openMenu.addEventListener("click", () => {
      subMenu.style.top = "-13.7rem";
    });
    closeMenu.addEventListener("click", () => {
      subMenu.style.top = "9rem";
    });
  ...
  return (
    <div className="menu">
      ...
      <div className="menu__app">
        <Fade top delay={200}>
          <div className="menu__icon">
            <i id="openSubMenu" className="uil uil-apps"></i>
          </div>
        </Fade>
        <div id="subMenu" className="submenu">
          <div className="submenu__close">
            <i id="closeSubMenu" className="uil uil-times"></i>
          </div>
